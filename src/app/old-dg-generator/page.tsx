...
export const metadata = {
  ...
  description: 'We buy old, used, and damaged DG generators from corporate offices and industries in Kolkata. Get the best price and hassle-free pickup. Contact us today!',
};
