...
const DelhiWhyChooseUs: React.FC = () => {
  return (
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-neutral-600 text-lg md:text-xl leading-relaxed font-secondary">
            ...
            bespoke services tailored to each client&apos;s specific needs,
            aiming for a seamless and rewarding experience.
          </p>
        </motion.div>
      </div>
    </SectionWrapper>
...
export default DelhiWhyChooseUs;
