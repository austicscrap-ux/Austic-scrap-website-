...
const KolkataScrapMainContent: React.FC = () => {
  return (
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16 mb-24">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold font-primary mb-8 text-neutral-900 leading-tight">
            Scrap Collection Services in Kolkata:{" "}
          ...
          <div className="space-y-6">
            <p className="text-neutral-600 text-lg leading-relaxed font-secondary">
              At Austic, we&apos;re here to make scrap collection and recycling
              in Kolkata hassle-free for you. We understand that life can get
              busy in the office, so we&apos;re ready to help. Whether you
              manage a corporate office, IT company, shopping center, bank,
              insurance firm, or organization, our services include purchasing
              and recycling office scrap, office workstations, and IT and non-IT
              scrap.
            </p>
            <p className="text-neutral-600 text-lg leading-relaxed font-secondary">
          ...
          <div className="mt-10 p-6 bg-neutral-50 rounded-2xl border border-neutral-100 flex items-center gap-4">
            ...
            <p className="text-neutral-700 font-bold">
              Fast Inspection & Immediate Quote in Kolkata
            </p>
          </div>
        </motion.div>
      ...
      <div className="mt-32">
        <div className="text-center mb-16">
          <h3 className="text-3xl md:text-4xl font-bold font-primary mb-4 text-neutral-900">
            Scrap We Buy in <span className="text-[#127749]">Kolkata</span>
          </h3>
...
export default KolkataScrapMainContent;
