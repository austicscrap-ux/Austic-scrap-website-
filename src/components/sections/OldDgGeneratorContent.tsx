  ...
  const generatorTypes = [
    {
      ...
      description: 'Used in factories and large plants. we buy old and outdated industrial DG sets, offering industrial-grade removal and premium valuation.'
    },
    {
      title: 'Corporate Office Generators',
      description: 'Medium-sized backup power sources from corporate halls. We provide efficient dismantling and the best market price for your office assets.'
    },
    {
      title: 'Silent Generators',
      description: 'Popular in commercial settings. We offer excellent rates for silent generators being replaced due to wear, tear, or modern upgrades.'
    }
  ];
    ...
    <div className="flex flex-col">
      ...
      <section className="relative w-full min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-hidden">
        <Image
          ...
          alt="Old DG Generator Scrap Buyer"
          fill
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 font-primary text-white leading-tight max-w-5xl mx-auto">
              Old DG Generator <span className="text-secondary">Scrap Buyer</span> in Kolkata
            </h1>
            <p className="text-neutral-200 text-lg md:text-xl mb-10 max-w-3xl mx-auto font-secondary leading-relaxed">
              Premium valuation for used, damaged, and obsolete Diesel Generator sets. We provide professional dismantling and eco-friendly resource recovery.
            </p>
      ...
      <SectionWrapper id="about-dg-generator" className="bg-white">
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-24">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold font-primary mb-8 text-neutral-900 leading-tight">
              Best Place to Sell <span className="text-[#127749]">Obsolete DG Sets</span>
            </h2>
            <div className="space-y-6">
              <p className="text-neutral-600 text-lg leading-relaxed font-secondary">
                In the bustling city of Kolkata, where industries and corporate offices rely heavily on Diesel Generator (DG) sets for backup power, there comes a time when these generators become old or damaged.
              </p>
              <p className="text-neutral-600 text-lg leading-relaxed font-secondary">
                At Austic Scrap, we specialize in buying used and scrap DG generators from businesses all across Kolkata. Whether it’s a small office generator or a massive industrial setup, we offer the best value, ensuring a smooth and eco-friendly disposal process.
              </p>
            </div>
          </motion.div>
        ...
        <div className="mt-32">
          <div className="text-center mb-16">
             <h3 className="text-3xl md:text-4xl font-bold font-primary mb-4 text-neutral-900">
               Types of <span className="text-[#127749]">DG Generators We Buy</span>
             </h3>
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8">
           {[
             { title: 'Best Scrap Prices', text: 'Highly competitive prices for old and unused DG sets with absolute transparency.' },
             { title: 'Hassle-Free Process', text: 'From inspection to dismantling and removal, our experienced team handles everything.' },
             { title: 'Eco-Friendly Manner', text: 'We follow strict environmental guidelines to reduce mechanical waste in Kolkata.' }
           ].map((item, idx) => (
             <motion.div 
               key={idx}
               ...
               viewport={{ once: true }}
             >
                <h4 className="text-xl font-bold font-primary mb-3 text-[#127749]">{item.title}</h4>
                <p className="text-neutral-600 font-secondary leading-relaxed">{item.text}</p>
             </motion.div>
           ))}
        </div>
        ...
        >
           ...
           <div className="relative z-10">
              <h3 className="text-3xl md:text-4xl font-bold font-primary mb-6">Contact Us for DG Generator Scrap Buying</h3>
              <p className="text-white/80 text-xl mb-10 max-w-2xl mx-auto font-secondary">
                Get the best scrap price across Kolkata. Assessment, dismantling, and quick pickup included.
              </p>
              <Link href="/contact">
