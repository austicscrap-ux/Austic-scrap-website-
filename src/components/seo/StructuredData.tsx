...
export default function StructuredData() {
  const organizationSchema = {
    ...
    areaServed: [
      ...
      { '@type': 'AdministrativeArea', name: 'Camac Street, Kolkata' },
      { '@type': 'AdministrativeArea', name: 'Dalhousie / BBD Bagh, Kolkata' },
      { '@type': 'AdministrativeArea', name: 'Burrabazar & Central Avenue, Kolkata' },
      { '@type': 'AdministrativeArea', name: 'Alipore & Ballygunge, Kolkata' },
      { '@type': 'AdministrativeArea', name: 'Kasba & EM Bypass, Kolkata' },
      { '@type': 'AdministrativeArea', name: 'Howrah District (Dhulagarh, Sankrail, Shibpur)' },
      { '@type': 'AdministrativeArea', name: 'North 24 Parganas (Barasat, Barrackpore, Bidhannagar)' },
      { '@type': 'AdministrativeArea', name: 'South 24 Parganas (Alipore, Behala, Jadavpur)' },
      { '@type': 'AdministrativeArea', name: 'Hooghly District (Dankuni, Serampore, Rishra)' },
      { '@type': 'AdministrativeArea', name: 'Nadia District (Kalyani Industrial Area)' },
      { '@type': 'AdministrativeArea', name: 'Purba Medinipur (Haldia Industrial Hub)' },
