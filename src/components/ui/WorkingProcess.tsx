      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-5">
        {items.map((item, index) => (
          <motion.div
            ...
            className="h-full"
          >
            <div className="group h-full bg-white p-5 rounded-2xl border border-neutral-100 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 relative overflow-hidden flex flex-col items-center text-center">
              <div className="absolute top-0 left-0 w-1.5 h-0 bg-[#127749] transition-all duration-500 group-hover:h-full" />

              <div className="icon-box w-12 h-12 rounded-xl bg-[#127749]/5 text-[#127749] mb-3 flex items-center justify-center group-hover:bg-[#127749] group-hover:text-white transition-all duration-500 transform group-hover:rotate-6">
